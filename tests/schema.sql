...
CREATE TABLE `spu` (
    ...
    `merchant_id` BIGINT(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '商店 id',
    `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '操作时间',
    `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
    PRIMARY KEY (`id`),
...
CREATE TABLE `sku` (
    ...
    `merchant_shop_id` BIGINT(20) UNSIGNED NOT NULL DEFAULT 0 COMMENT '商店连锁店 id',
    `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '',
    `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '',
    `share_title` VARCHAR(256) NOT NULL DEFAULT '' COMMENT '分享标题',
    `shelf_up_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '上架时间',
    `shelf_down_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '下架时间',
    PRIMARY KEY (`id`),
...
CREATE TABLE `promotion` (
    ...
    `price` INT(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'sku 原价，单位 分',
...
CREATE TABLE `feedback` (
    ...
    `info` TEXT DEFAULT NULL COMMENT '用户反馈，json 格式',
    `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '操作时间',
    `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
